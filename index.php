  ...
  <div class="overlay">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div id="content">
                    <h1>Welcome to Debre Berhan University Portal Website</h1>
                    <h1>By Logining in or registering you will start getting detailed information about our university</h1>
